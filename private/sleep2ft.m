...
%sleep2FT run a function on each sleep epoch
%
% data = sleep2ft(cfg, D)
%
% cfg
...
% 11/12/22 automatically add path
% 11/11/02 channel can now be a cell with labels
% 11/09/08 allows for concatenation
% 11/09/07 created

%---------------------------%
%-input check
%-----------------%
addpath /data/toolbox/fieldtrip/
ft_defaults
